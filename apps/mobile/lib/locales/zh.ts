export const ZH_MESSAGES: Record<string, string> = {
  ...
  To: "收件人",
  "Send options": "发送选项",
  "Could not queue message": "无法将消息加入队列",
  "Remove mentions before queueing.": "请先移除提及，再加入队列。",
  "Remove reply before queueing.": "请先取消回复，再加入队列。",
  "Remove mentions and reply before queueing.": "请先移除提及并取消回复，再加入队列。",
  Current: "当前",
  Requested: "请求的模型",
  "No models": "暂无模型",
  "Pi selection": "Pi 选择",
  ...
  Pair: "配对",
  "Pair machine": "配对机器",
  "Paired machines pause while this computer sleeps.": "此电脑休眠时，配对机器上的任务会暂停。",
  "Pairing expired.": "配对已过期。",
  Preview: "预览",
  "Preview unavailable": "预览不可用",
  "Remove ": "移除 ",
  Revoke: "撤销",
  "Revoke {name}": "撤销 {name}",
  "Revoke {name}?": "要撤销 {name} 吗？",
  "Runs on": "运行位置",
  "Service action failed": "服务操作失败",
  "Service runtime is unavailable on this computer.": "此电脑不支持服务运行。",
  Services: "服务",
  Start: "启动",
  "Start ": "启动 ",
  "Stop ": "停止 ",
  "The machine loses access.": "此机器将失去访问权限。",
  "Unavailable machine": "机器不可用",
  "Waiting for machine…": "等待机器…",
  "Execution {number}": "执行 {number}",
  "Participant {number}": "参与者 {number}",
  ...
  Stopped: "已停止",
  Waiting: "等待中",
  "1 message with": "1 条消息 ·",
  "1 message with {peer}": "与 {peer} 的 1 条消息",
  "{count} messages with": "{count} 条消息 ·",
  "{count} messages with {peer}": "与 {peer} 的 {count} 条消息",
  "Account default": "账户默认",
  "Could not load this chat.": "无法加载此聊天。",
  "Created routine": "已创建例行任务",
  Default: "默认",
  Effective: "当前生效",
  "Group actions": "群组操作",
  ...
  Pending: "待处理",
  "Retry now": "立即重试",
  "Run {number}": "运行 {number}",
  "Search models": "搜索模型",
  Thinking: "思考深度",
  "This chat is view-only": "此聊天仅供查看",
  Unavailable: "不可用",
  "Updated routine": "已更新例行任务",
  "Use bot model": "使用 Bot 模型",
  Visibility: "可见性",
  Queue: "队列",
  "Queue for bot": "选择队列所属 Bot",
  Steer: "引导",
  Participant: "参与者",
  "Steer participant": "引导参与者",
  "Message to participant": "发送给参与者的消息",
  "Use current project": "使用当前项目",
  "Follow-up": "后续消息",
  Hold: "暂缓",
  Held: "已暂缓",
  "Release hold": "解除暂缓",
  Pause: "暂停",
  Resume: "继续",
  "Pause after tools": "工具完成后暂停",
  "Pause pending": "等待暂停",
  "Recovery hold": "等待恢复",
  Compaction: "上下文压缩",
  "Delivery pending": "等待投递",
  "Delivery uncertain": "投递状态不明",
  Execution: "执行详情",
  ...
  "Queue message": "加入队列",
  "Drain all": "全部合并发送",
  "Participant targeted": "定向发送给参与者",
  "Message options": "消息选项",
  "Removed on save": "保存后移除",
  "Add queued message": "添加排队消息",
  "Move up": "上移",
  "Move down": "下移",
  ...
  Attachments: "附件",
  Close: "关闭",
  "Resume uncertain deliveries?": "继续状态不明的投递？",
  "A delivery may already have reached the bot. Resuming can send it again.":
    "消息可能已送达 Bot。继续操作可能会重复发送。",
  Flow: "执行关系",
  "No retained events": "没有保留的事件",
  "No retained relationships": "没有保留的关系",
  Relationships: "关系",
  Participants: "参与者",
  Evidence: "依据",
  "{count} runs": "{count} 次运行",
  "Related run {number}": "相关运行 {number}",
  "Inspect run": "查看运行",
  "Show events": "显示事件",
  "All events": "全部事件",
  "Evidence is outside the loaded events": "依据不在已加载的事件中",
  "Load more": "加载更多",
  Refresh: "刷新",
  "More related runs are available. Open a run to inspect it.":
    "还有更多相关运行。打开运行即可查看。",
  "Rotation and fallback": "轮换与回退",
  "Pool model": "连接池模型",
  Rotation: "轮换方式",
  "In order": "按顺序",
  "Round robin": "轮询",
